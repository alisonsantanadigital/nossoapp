...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#090E17] flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md bg-[#151E2E] p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/5 mb-6">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          {success && (
            <p className="text-indigo-400 text-sm text-center font-medium bg-indigo-400/10 p-2 rounded-lg">
              {success}
            </p>
          )}
          ...
          <div className="flex items-center justify-between mt-2 mb-6">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                className="rounded text-indigo-400 focus:ring-teal-600 w-4 h-4 border-white/10"
              />
            ...
            <button
              ...
              type="button"
              className="text-sm font-medium text-indigo-400 hover:text-sky-700"
            >
              Esqueci a senha
            </button>
          </div>
      ...
      <button
        ...
        disabled={loading}
        className="flex items-center gap-2 px-4 py-3 bg-[#151E2E] border border-white/5 rounded-3xl text-slate-300 text-sm font-medium hover:bg-white/[0.04] transition-colors shadow-sm"
      >
